...
class ComponentTemplateModel(WebhooksMixin, ChangeLoggedModel):
    ...
    class Meta:
        verbose_name = "Component Template Model"
        verbose_name_plural = "Component Template Models"
        abstract = True
...
class ModularComponentTemplateModel(ComponentTemplateModel):
    ...
    class Meta:
        verbose_name = "Modular Component Template Model"
        verbose_name_plural = "Modular Component Template Models"
        abstract = True
