...
class ComponentModel(NetBoxModel):
    ...
    class Meta:
        verbose_name = "Компонентная модель"
        verbose_name_plural = "Компонентные модели"
        abstract = True
...
class ModularComponentModel(ComponentModel):
    ...
    class Meta:
        verbose_name = "Modular Component Model"
        verbose_name_plural = "Modular Component Models"
        abstract = True
...
class LinkTermination(models.Model):
    ...
    class Meta:
        verbose_name = "Link Termination"
        verbose_name_plural = "Link Terminations"
        abstract = True
...
class ConsolePort(ModularComponentModel, LinkTermination, PathEndpoint):
    ...
    class Meta:
        ...
        verbose_name_plural = "Консольные порты"
...
class ConsoleServerPort(ModularComponentModel, LinkTermination, PathEndpoint):
    ...
    class Meta:
        verbose_name = "Сервеный порт"
        verbose_name_plural = "Серверные порты"
        ordering = ('device', '_name')
        unique_together = ('device', 'name')
...
class PowerPort(ModularComponentModel, LinkTermination, PathEndpoint):
    ...
    class Meta:
        ...
        verbose_name_plural = "Порты питания"
        ordering = ('device', '_name')
        unique_together = ('device', 'name')
...
class BaseInterface(models.Model):
    ...
    class Meta:
        verbose_name = "Базовый интерфейс"
        verbose_name_plural = "Базовые интерфейсы"
        abstract = True
...
class Interface(ModularComponentModel, BaseInterface, LinkTermination, PathEndpoint):
    ...
    lag = models.ForeignKey(
        ...
        null=True,
        blank=True,
        verbose_name='Интерфейс агрегации'
    )
    type = models.CharField(
        verbose_name = "тип",
        max_length=50,
    ...
    rf_channel_width = models.DecimalField(
        ...
        blank=True,
        null=True,
        verbose_name='Ширина канала (MHz)'
    )
    tx_power = models.PositiveSmallIntegerField(
        blank=True,
        null=True,
        validators=(MaxValueValidator(127),),
        verbose_name='Мощность (dBm)'
    )
...
class FrontPort(ModularComponentModel, LinkTermination):
    ...
    class Meta:
        verbose_name = "Передний порт"
        verbose_name_plural = "Передние порты"
        ordering = ('device', '_name')
        unique_together = (
            ('device', 'name'),
...
class RearPort(ModularComponentModel, LinkTermination):
    ...
    class Meta:
        verbose_name = "Задний порт"
        verbose_name_plural = "Задние порты"
        ordering = ('device', '_name')
        unique_together = ('device', 'name')
...
class ModuleBay(ComponentModel):
    ...
    class Meta:
        ...
        verbose_name_plural = "Модульные отсеки"
        ordering = ('device', '_name')
        unique_together = ('device', 'name')
...
class InventoryItemRole(OrganizationalModel):
    ...
    class Meta:
        verbose_name = "Роль компонентов"
        verbose_name_plural = "Роли компонентов"
        ordering = ['name']
...
class InventoryItem(MPTTModel, ComponentModel):
    ...
    class Meta:
        verbose_name = "Встроенное устройство"
        verbose_name_plural = "Встроенные устройства"
