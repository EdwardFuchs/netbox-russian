...
class DeviceType(NetBoxModel):
    ...
    subdevice_role = models.CharField(
        ...
        blank=True,
        verbose_name='Вышестоящий/дочерний статус',
...
class ModuleType(NetBoxModel):
    ...
    class Meta:
        ...
        verbose_name_plural = "Типы модуля"
        ordering = ('manufacturer', 'model')
        unique_together = (
            ('manufacturer', 'model'),
        )
...
class DeviceRole(OrganizationalModel):
    ...
    vm_role = models.BooleanField(
        default=True,
        verbose_name='Роль виртуальной машины',
...
class Platform(OrganizationalModel):
    ...
    napalm_driver = models.CharField(
        max_length=50,
        blank=True,
        verbose_name='NAPALM драйвер',
        help_text='The name of the NAPALM driver to use when interacting with devices'
    )
    napalm_args = models.JSONField(
        blank=True,
        null=True,
        verbose_name='NAPALM аргументы',
...
class Device(NetBoxModel, ConfigContextModel):
    ...
    virtual_chassis = models.ForeignKey(
        verbose_name = "Виртуальное шасси",
        to='VirtualChassis',
        on_delete=models.SET_NULL,
...
class Module(NetBoxModel, ConfigContextModel):
    ...
    def save(self, *args, **kwargs):
        ...
        for templates, component_attribute, component_model in [
            ...
            ("interfacetemplates", "Интерфейсы", Interface),
...
class VirtualChassis(NetBoxModel):
    ...
    class Meta:
        ordering = ['name']
        verbose_name_plural = 'виртуальные шасси'
