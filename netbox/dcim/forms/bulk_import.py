...
class DeviceBayCSVForm(NetBoxModelCSVForm):
    ...
    installed_device = CSVModelChoiceField(
        label='Установленное устройство',
        queryset=Device.objects.all(),
        required=False,
        to_field_name='name',
...
class CableCSVForm(NetBoxModelCSVForm):
    ...
    side_a_device = CSVModelChoiceField(
        label='Сторона устройства А',
        queryset=Device.objects.all(),
        to_field_name='name',
        help_text='Side A device'
    )
    side_a_type = CSVContentTypeField(
        label='Тип устройства А',
        queryset=ContentType.objects.all(),
        limit_choices_to=CABLE_TERMINATION_MODELS,
        help_text='Side A type'
    )
    side_a_name = forms.CharField(
        label='Имя устройста А',
        help_text='Side A component name'
    )

    # Termination B
    side_b_device = CSVModelChoiceField(
        label='Сторона устройства Б',
        queryset=Device.objects.all(),
        to_field_name='name',
        help_text='Side B device'
    )
    side_b_type = CSVContentTypeField(
        label='Тип устройства Б',
        queryset=ContentType.objects.all(),
        limit_choices_to=CABLE_TERMINATION_MODELS,
        help_text='Side B type'
    )
    side_b_name = forms.CharField(
        label='Имя устройста Б',
