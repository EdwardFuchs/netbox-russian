...
class RackSerializer(NetBoxModelSerializer):
    ...
    facility_id = serializers.CharField(max_length=50, allow_blank=True, allow_null=True, label='Код региона',
                                        default=None)
...
class DeviceSerializer(NetBoxModelSerializer):
    ...
    position = serializers.IntegerField(allow_null=True, label='Позиция (юнит)', min_value=1, default=None)
