...
class ClusterTypeForm(NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "Cluster Type Form"
        verbose_name_plural = "Cluster Type Forms"
        model = ClusterType
        fields = (
...
class ClusterGroupForm(NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "Cluster Group Form"
        verbose_name_plural = "Cluster Group Forms"
        model = ClusterGroup
        fields = (
            'name', 'slug', 'description', 'tags',
        )
...
class ClusterForm(TenancyForm, NetBoxModelForm):
    ...
    fieldsets = (
        ('Кластер', ('name', 'type', 'group', 'region', 'site_group', 'site', 'tags')),
        ('Учреждения', ('tenant_group', 'tenant')),
    )

    class Meta:
        verbose_name = "Cluster Form"
        verbose_name_plural = "Cluster Forms"
        model = Cluster
        fields = (
...
class ClusterAddDevicesForm(BootstrapMixin, forms.Form):
    ...
    class Meta:
        verbose_name = "Cluster Add Devices Form"
        verbose_name_plural = "Cluster Add Devices Forms"
        fields = [
...
class VirtualMachineForm(TenancyForm, NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "Virtual Machine Form"
        verbose_name_plural = "Virtual Machine Forms"
...
class VMInterfaceForm(InterfaceCommonForm, NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "VMInterface Form"
        verbose_name_plural = "VMInterface Forms"
        model = VMInterface
        fields = [
