...
class WirelessAuthenticationBase(models.Model):
    ...
    class Meta:
        verbose_name = "Wireless Authentication Base"
        verbose_name_plural = "Wireless Authentication Bases"
        abstract = True
...
class WirelessLANGroup(NestedGroupModel):
    ...
    class Meta:
        verbose_name_plural = "Группы wi-fi"
        ordering = ('name', 'pk')
        unique_together = (
            ('parent', 'name')
        )
...
class WirelessLAN(WirelessAuthenticationBase, NetBoxModel):
    ...
    class Meta:
        verbose_name_plural = "Wi-fi сети"
        ordering = ('ssid', 'pk')
...
class WirelessLink(WirelessAuthenticationBase, NetBoxModel):
    ...
    class Meta:
        ...
        verbose_name_plural = "Беспроводные"
        ordering = ['pk']
