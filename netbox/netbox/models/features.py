...
class ChangeLoggingMixin(models.Model):
    ...
    class Meta:
        verbose_name = "Change Logging Mixin"
        verbose_name_plural = "Change Logging Mixins"
        abstract = True
...
class CustomFieldsMixin(models.Model):
    ...
    class Meta:
        verbose_name = "Custom Fields Mixin"
        verbose_name_plural = "Custom Fields Mixins"
        abstract = True
...
class CustomLinksMixin(models.Model):
    ...
    """
    class Meta:
        verbose_name = "Custom Links Mixin"
        verbose_name_plural = "Custom Links Mixins"
        abstract = True
...
class CustomValidationMixin(models.Model):
    ...
    """
    class Meta:
        verbose_name = "Custom Validation Mixin"
        verbose_name_plural = "Custom Validation Mixins"
        abstract = True
...
class ExportTemplatesMixin(models.Model):
    ...
    """
    class Meta:
        verbose_name = "Export Templates Mixin"
        verbose_name_plural = "Export Templates Mixins"
        abstract = True
...
class JobResultsMixin(models.Model):
    ...
    """
    class Meta:
        verbose_name = "Job Results Mixin"
        verbose_name_plural = "Job Results Mixins"
        abstract = True
...
class JournalingMixin(models.Model):
    ...
    class Meta:
        verbose_name = "Journaling Mixin"
        verbose_name_plural = "Journaling Mixins"
        abstract = True
...
class TagsMixin(models.Model):
    ...
    class Meta:
        verbose_name = "Tags Mixin"
        verbose_name_plural = "Tags Mixins"
        abstract = True
...
class WebhooksMixin(models.Model):
    ...
    """
    class Meta:
        verbose_name = "Webhooks Mixin"
        verbose_name_plural = "Webhooks Mixins"
        abstract = True
