...
class Prefix(GetAvailablePrefixesMixin, NetBoxModel):
    ...
    is_pool = models.BooleanField(
        verbose_name='Это диапазон адресов',
        default=False,
...
class IPRange(NetBoxModel):
    ...
    class Meta:
        ...
        verbose_name_plural = 'IP диапазоны'
...
class IPAddress(NetBoxModel):
    ...
    def clean(self):
        ...
        if self.pk:
            for cls, attr in ((Device, 'device'), (VirtualMachine, 'Виртуальная машина')):
