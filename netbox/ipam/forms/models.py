...
class VRFForm(TenancyForm, NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "VRFForm"
        verbose_name_plural = "VRFForms"
        model = VRF
        fields = [
...
class RouteTargetForm(TenancyForm, NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "Route Target Form"
        verbose_name_plural = "Route Target Forms"
        model = RouteTarget
        fields = [
...
class RIRForm(NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "RIRForm"
        verbose_name_plural = "RIRForms"
        model = RIR
        fields = [
...
class AggregateForm(TenancyForm, NetBoxModelForm):
    ...
    fieldsets = (
        ('Сеть', ('prefix', 'rir', 'date_added', 'description', 'tags')),
        ('Учреждения', ('tenant_group', 'tenant')),
    )

    class Meta:
        verbose_name = "Aggregate Form"
        verbose_name_plural = "Aggregate Forms"
        model = Aggregate
        fields = [
...
class ASNForm(TenancyForm, NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "ASNForm"
        verbose_name_plural = "ASNForms"
        model = ASN
        fields = [
...
class RoleForm(NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "Role Form"
        verbose_name_plural = "Role Forms"
        model = Role
        fields = [
...
class PrefixForm(TenancyForm, NetBoxModelForm):
    ...
    fieldsets = (
        ('Подсеть', ('prefix', 'status', 'vrf', 'role', 'is_pool', 'mark_utilized', 'description', 'tags')),
        ('Site/VLAN Assignment', ('region', 'site_group', 'site', 'vlan_group', 'vlan')),
        ('Учреждения', ('tenant_group', 'tenant')),
    )

    class Meta:
        verbose_name = "Prefix Form"
        verbose_name_plural = "Prefix Forms"
        model = Prefix
        fields = [
...
class IPRangeForm(TenancyForm, NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "IPRange Form"
        verbose_name_plural = "IPRange Forms"
        model = IPRange
        fields = [
...
class IPAddressForm(TenancyForm, NetBoxModelForm):
    ...
    primary_for_parent = forms.BooleanField(
        required=False,
        label='Назначьте основной IP-адрес для устройства/виртуальной машины'
    )

    class Meta:
        verbose_name = "IPAddress Form"
        verbose_name_plural = "IPAddress Forms"
        model = IPAddress
        fields = [
...
class IPAddressBulkAddForm(TenancyForm, NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "IPAddress Bulk Add Form"
        verbose_name_plural = "IPAddress Bulk Add Forms"
        model = IPAddress
        fields = [
...
class FHRPGroupForm(NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "HRPGroup Form"
        verbose_name_plural = "HRPGroup Forms"
        model = FHRPGroup
        fields = (
...
class FHRPGroupAssignmentForm(BootstrapMixin, forms.ModelForm):
    ...
    class Meta:
        verbose_name = "HRPGroup Assignment Form"
        verbose_name_plural = "HRPGroup Assignment Forms"
...
class VLANGroupForm(NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "LANGroup Form"
        verbose_name_plural = "LANGroup Forms"
        model = VLANGroup
        fields = [
...
class VLANForm(TenancyForm, NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "LANForm"
        verbose_name_plural = "LANForms"
        model = VLAN
        fields = [
...
class ServiceTemplateForm(NetBoxModelForm):
    ...
    class Meta:
        verbose_name = "Service Template Form"
        verbose_name_plural = "Service Template Forms"
